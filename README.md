...
**Archive replayed:** 122 <!-- results:archive.snapshots --> snapshots
...
recorder v1 and 5 <!-- results:archive.schema2_snapshots --> from v2.
...
| v2 (full catalog) | 5 <!-- results:ladders.by_recorder.schema2.snapshots --> | 123,507 <!-- results:ladders.by_recorder.schema2.adjacent_pairs --> | 17 <!-- results:ladders.by_recorder.schema2.inversions_gross --> | 3 <!-- results:ladders.by_recorder.schema2.inversions_net --> |
...
308 <!-- results:ladders.inversions_gross_total --> gross inversions fall
...
The v2 slice is 5 <!-- results:ladders.by_recorder.schema2.snapshots -->
...
17,367 <!-- results:ladders.negative_mass_gross_total --> times. That is a
...
1,708,477 <!-- results:kalshi_identity.books_checked_total --> of
1,708,477 <!-- results:kalshi_identity.books_checked_total --> two-sided
...
59,695 <!-- results:predictit_complement.pairs_total --> PredictIt YES/NO
ask pairs give 0 <!-- results:predictit_complement.gross_total -->
violations gross. 114,024 <!-- results:polymarket_complement.pairs_total -->
...
54 <!-- results:polymarket_complement.snapshots_numeric_era --> clean
...
122 <!-- results:archive.snapshots --> snapshots —
928,215 <!-- results:ladders.adjacent_pairs_total --> adjacent strike
pairs, 59,695 <!-- results:predictit_complement.pairs_total --> PredictIt
pairs, 114,024 <!-- results:polymarket_complement.pairs_total -->
Polymarket pairs, 30,897 <!-- results:buckets.screened_total --> screened
...
of fee in all 5 <!-- results:ladders.by_recorder.schema2.snapshots -->
...
**Coverage today.** 33,380 <!-- results:calibration.settlements_read -->
settled markets have been captured, and
4,754 <!-- results:calibration.observations_headline --> market/horizon
cells have both an outcome and a usable pre-settlement quote; another
16,031 <!-- results:calibration.observations_rejected_stale --> were
refused for a stale quote and
980 <!-- results:calibration.observations_rejected_one_sided --> for a
